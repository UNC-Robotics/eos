...
class ExperimentGraph:
    ...
    def get_task_config(self, task_name: str) -> TaskConfig:
        return self.get_task_node(task_name)["task_config"].model_copy(deep=True)

    def get_task_spec(self, task_name: str) -> TaskSpecConfig:
        return self._task_specs.get_spec_by_type(self.get_task_node(task_name)["task_config"].type)
