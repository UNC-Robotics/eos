...
class AllocationRequestDeviceModel(Base):
    """Database model for devices in an allocation request."""

    __tablename__ = "allocation_request_devices"
    ...
    __table_args__ = (Index("idx_alloc_req_devices_lab_name", "lab_name"),)
