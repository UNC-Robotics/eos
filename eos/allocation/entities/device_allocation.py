...
from sqlalchemy import String, Boolean, DateTime, ForeignKey, ForeignKeyConstraint, Index
...
class DeviceAllocationModel(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(["lab_name", "name"], ["devices.lab_name", "devices.name"]),
        Index("ix_device_allocations_owner", "owner"),
    )
