...
export const getButtonClasses = (
  ...
  clsx(
    {
      "box-border leading-[48px] text-base font-medium inline-flex items-center focus:outline-none transition-colors transition-shadow duration-300": true,
      ...
      "bg-blue-600 hover:bg-blue-700 text-white dark:bg-yellow-500 dark:hover:bg-yellow-600 dark:text-slate-900":
      ...
      "bg-warn-light-500 dark:bg-warn-dark-500 hover:bg-warn-light-400 hover:dark:bg-warn-dark-400 text-white dark:text-white":
        variant === ButtonVariants.Primary && color === ButtonColors.Warn,
      "border border-gray-300 dark:border-slate-700 text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-slate-800 focus:bg-gray-100 dark:focus:bg-slate-800 disabled:text-gray-400 disabled:hover:bg-transparent disabled:dark:hover:bg-transparent disabled:cursor-not-allowed disabled:dark:text-gray-600":
      ...
      "px-5 h-[48px]": size === ButtonSizes.Small,
    },
