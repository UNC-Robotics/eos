...
const styles = (error: boolean, disabled: boolean, roundnessClasses: string = "rounded-md") =>
  clsx(
    {
      "h-[52px] mb-[2px] p-[12px] bg-input-light-background dark:bg-input-dark-background transition-colors duration-300 grow": true,
      ...
      "focus:outline-none focus:ring-0 text-lg text-black dark:text-white placeholder:italic placeholder-gray-700 dark:placeholder-gray-700": true,
...
export const TextInput = forwardRef<HTMLInputElement, TextInputProps>(
  (
    ...
    return (
      <label className="text-sm text-input-light-label dark:text-input-dark-label relative flex flex-col">
