  ...
  return (
    ...
    >
      ...
      <ScrollArea.Root className="h-[calc(100%-57px)]">
        ...
        >
          <ScrollArea.Thumb className="flex-1 bg-gray-400 dark:bg-slate-600 rounded-[10px] relative before:content-[''] before:absolute before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:w-full before:h-full before:min-h-[44px]" />
        </ScrollArea.Scrollbar>
      </ScrollArea.Root>
    </div>
  );
